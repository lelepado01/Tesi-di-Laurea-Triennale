...
\begin{center}
    ...
    \begin{tabular}{ |c|c|c|c| }
        \hline
        Autovelox & Incidenti totali & Incidenti $Km^2$ & Incidenti zona \\ 
        \hline
        \rowcolor{TableGray}
...
\todo{lelepado: tabella troppo grande?}
...
\todo{finire di leggere https://www.isfort.it/wp-content/uploads/2019/09/Rapporto\_Mobilita\_2018.pdf}
%https://www.isfort.it/wp-content/uploads/2019/09/Rapporto_Mobilita_2018.pdf
\todo{https://sbilanciamoci.info/meno-passeggeri-piu-automobili-4357/ qui si stimano}
...
\todo{https://www.lautomobile.aci.it/articoli/2019/04/17/disattenzione-al-volante.html}
...
In provincia di Palermo, d'altra parte, non risulta che nessun mese abbbia un numero di incidenti 
...
gli incidenti divisi per trimestre dove, per esempio, per primo trimestre si intende: 
...
Le percentuali delle prime tre categorie di incidenti sono riportate nella tabella sottostante: 

\begin{center}
    \def\arraystretch{1.5}%  
    \begin{tabular}{ |c|c|c|c| } 
    \hline
    Anno & Prima Categoria & Seconda Categoria & Terza Categoria \\ 
    \hline
    \rowcolor{TableGray}
    2010 & Frontale-Laterale (35.1\%) & Tamponamento (14.3\%) & Investimento Pedoni (13.4\%) \\
    2011 & Frontale-Laterale (34.7\%) & Tamponamento (18.5\%) & Laterale (11.6\%) \\
    \rowcolor{TableGray}
    2012 & Frontale-Laterale (36.5\%) & Tamponamento (14.6\%) & Investimento Pedoni (13.3\%) \\
    2013 & Frontale-Laterale (35\%) & Tamponamento (16\%) & Investimento Pedoni (13.7\%) \\
    \rowcolor{TableGray}
    2014 & Frontale-Laterale (33.3\%) & Tamponamento (18.6\%) & Investimento Pedoni (11.2\%) \\
    2015 & Frontale-Laterale (32.9\%) & Tamponamento (18.9\%) & Laterale (11.3\%) \\
    \rowcolor{TableGray}
    2016 & Frontale-Laterale (33.1\%) & Tamponamento (18.8\%) & Laterale (11.5\%) \\
    2017 & Frontale-Laterale (32.4\%) & Tamponamento (19\%) & Laterale (11.8\%) \\
    \rowcolor{TableGray}
    2018 & Frontale-Laterale (32.5\%) & Tamponamento (18.6\%) & Laterale (11.8\%) \\
    \hline
    \end{tabular}
\end{center}
...
\textit{Scontro frontale-laterale} e \textit{tamponamento}. Anche le percentuali corrispondenti restano molto simili, 
con la prima categoria sempre attorno al $35\%$ e la seconda attorno al $18\%$.

La terza categoria invece, è dove si inizano ad osservare delle differenze, poichè nelle prime annate 
si alternano \textit{investimento di pedoni} e \textit{scontro laterale}, con percentuali simili, 
attorno al $12\%$.

Ciò che è possibile ricavare dalla tabella, è che non sembrano esistere particolari fattori che 
influenzano quali tipi di incidenti vengono commessi maggiormente in un anno. 
...
Non avendo accesso a questo tipo di informazioni, si è utilizzato l'indice di mortalità per tipologia 
di sinistro.
...
\begin{center}
    $Indice\_Mortalita\_Strada\_X = \frac{Numero\_Morti\_Strada\_X * 100}{Numero\_Incidenti\_Strada\_X}$ 
\end{center}

\begin{center}
    $Indice\_Feriti\_Strada\_X = \frac{Numero\_Feriti\_Strada\_X * 100}{Numero\_Incidenti\_Strada\_X}$ 
\end{center}

\todo{mettere a posto frazione}
...
Ne risulta che tutti gli insiemi sono strettamente correlati tra loro. I valori sono riportati nella 
tabella sottostante: 
