...
di cui si parla nella frase tra parentesi, cioè l'obbligo di condividere i dati modificati 
...
Queste categorie hanno permesso la valutazione della qualità delle informazioni condivise 
dalle istituzioni, e hanno aperto la strada alla creazione di nuove metriche, come 
...
creata da un utente anonimo, dunque senza possibilità di verificarne 
...
Non è possibile dire se su una certa strada si ha un numero alto di 
...
il numero di patenti per regione.
...
presenza, nella via o viale, di trasporti pubblici in una città come Milano.
...
reale, questo è disponibile, ma non è particolarmente utile 
...
Le ricerche per un file contenente informazioni su questi metadati sono state eseguite sia 
...
\begin{center}
    ...
    dataset/incidenti/aci/strade_provinciali & Portale ACI\footnotemark[5] \\
    \rowcolor{TableGray}
