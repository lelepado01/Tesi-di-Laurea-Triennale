...
Una delle domande che ci si potrebbe porre, è se il pavè, a Milano, 
...
si è preferito quindi usare una sintesi di queste, provieniente da 
...
\quotestyle{lower bound}, perchè il valore è abbassato dalle aree in cui non 
...
contenenti informazioni come il numero identificatore della linea, 
...
\quotestyle{strada}, \quotestyle{manto stradale}, \quotestyle{pavè}, 
...
tram a Milano siano in pavè, è possibile ottenere un dataset di taglia discreta.
...
poichè questo studio è stato svolto in concomitanza a un lungo periodo di quarantena 
...
Per stimare queste percentuali si è cercato, innanzi tutto, articoli o dataset online, con 
...
%\clearpage
\section{Il pavè a Milano influisce in qualche modo sull'incidentalità?}
...
In particolare, i capitoli che fanno utilizzo dei dati geolocalizzati, soffrono la mancanza di 
