...
\lighttext{(
    \noindent id : progressivo numerico,\\
    \noindent provincia\_residenza, \\
    \noindent categoria\_patente : più elevata, \\
    \noindent abilitato\_a : se la patente ha abilitazioni A2-A4, \\
    \noindent data\_rilascio, \\
    \noindent nazionalita: di emissione \\
)}
...
Avendo a disposizione dati riguardanti le strade provinciali e le autostrade, 
