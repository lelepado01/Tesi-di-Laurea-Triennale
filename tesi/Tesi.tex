...
\todo{specificare procedimento}
\todo{provare, invece di eliminare outlier, a usare scala logaritmica per x}

Se si escludono gli outlier\footnote{In un campione di osservazioni, un outlier è un valore anomalo, 
...
Nella figura \ref{fig:estate-inverno}, sono rappresentati i numeri di incidenti presenti in mesi 
...
\todo{la velocità del vento è una conclusione che merita approfondimento (avendo più dati)}
