...
\todo{atrent: minimale ma ok, vedi todo aggiunti}
...
\begin{itemize}
    ...
    \item \textbf{Machine Readability}: il lavoro deve leggibile e modificabile da computer; 
...
a memorizzarlo in un formato che non comporti l'utilizzo di un programma proprietario 
per la lettura o la modifica.


Concentrandosi sugli open data, e in particolare sulla storia di questi, 
...
successive al posizionamento delle telecamere. \todo{atrent: tutta questa sezione va resa più ipotetica perché non hai informazioni "causali"}
...
%\clearpage
\subsection{Il tipo di veicolo dipende dalla strada?}\todo{atrent: non avevo detto di riformulare il titolo?}
\todo{ATOK}
...
capitolo: Statistica descrittiva, pagine: 246-248)} 
...
\todo{atrent: potresti trovare bibliografia a supporto delle tue conclusioni, anche solo il fatto che le assicurazioni fanno pagare meno alle donne (almeno così sapevo)}

Un frequente stereotipo riguardante le donne, è che 
siano meno abili alla guida rispetto alla controparte maschile. \todo{atrent: frase pericolosa, andrebbe sostanziata, anche se lo dici solo per poi negarla}
...
%\clearpage
\subsection{I passeggeri influiscono sull'incidentalità?}\todo{atrent: secondo me molti titoli vanno rifatti, mi suonano strani dal punto di vista statistico}
\todo{ATOK}
...
%\clearpage
\subsection{Incidentalità nelle fasce orarie della mattina}
\todo{ATOK}
...
%\clearpage
\subsection{Quanto influiscono le vacanze sull'incidentalità?}
\todo{Da Leggere}
...
\lighttext{(\\
\indent\columnstyle{pedone\_morto\_1\_\_sesso}, \\
\indent\columnstyle{pedone\_morto\_1\_\_et\_}\footnote{I label contenenti \quotestyle{et} indicano l'età dei pedoni}, \\
\indent\columnstyle{pedone\_ferito\_1\_\_sesso}, \\
\indent\columnstyle{pedone\_ferito\_1\_\_et\_}, \\
\indent\columnstyle{pedone\_morto\_2\_\_sesso}, \\
\indent\columnstyle{pedone\_morto\_2\_\_et\_}, \\
\indent\columnstyle{pedone\_ferito\_2\_\_sesso}, \\
\indent\columnstyle{pedone\_ferito\_2\_\_et\_}, \\
\indent\columnstyle{pedone\_morto\_3\_\_sesso}, \\
\indent\columnstyle{pedone\_morto\_3\_\_et\_}, \\
\indent\columnstyle{pedone\_ferito\_3\_\_sesso}, \\
\indent\columnstyle{pedone\_ferito\_3\_\_et\_}, \\
\indent\columnstyle{pedone\_morto\_4\_\_sesso}, \\
\indent\columnstyle{pedone\_morto\_4\_\_et\_}, \\
\indent\columnstyle{pedone\_ferito\_4\_\_sesso}, \\
\indent\columnstyle{pedone\_ferito\_4\_\_et\_}\\
)} 
...
\subsection{Gli incidenti su autostrade dipendono dai mesi dell'anno?}
\todo{Da Leggere}
...
\todo{Da leggere + parte da controllare}
...
che in questo caso sia presente 
...
La cartella \columnstyle{tesi}\todo{atrent: io questo columnstyle lo vedo identico al resto} contiene la maggior parte delle immagini presenti 
...
% \todo{atrent: leggi \url{http://appunti.linux.it/a2/a269.htm\#almltitle2772}}
