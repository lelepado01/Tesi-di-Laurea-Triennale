...
\begin{figure}
    ...
    \label{fig:arpa}
\end{figure}
\todo{atrent: la fonte si mette tra parentesi nella caption, inoltre metti le label su ogni figura e citala nel testo}
...
\todo{rendere più precisi i tracciati delle autostrade}
\begin{figure}
