...
\todo{incidenti geolocalizzati, magari bubble chart?}
...
\begin{figure}
    ...
    \includegraphics[width=0.55\linewidth]{../dataset/pave/Cartina_Milano_Strade_Pavimentazione_Pavé_2.jpg}
...
\todo{lelepado: tengo questo capitolo?}
...
Nella figura \ref{fig:tipo-incidente}

\todo{descrivere figura incidenti frequenti}
...
\todo{aggiungere codice per questa normalizzazione}
...
\todo{finire discorso su patenti e incidenti}
...
Nelle figure \ref{fig:lazio-strade}\dots

\todo{finire descrizione lazio province e lombardia}
...
\todo{descrizione e spiegazione mappa bubble chart}
...
\todo{includere tendenza di altri anni}
...
\todo{guarda dataset e tendenza del turismo}
