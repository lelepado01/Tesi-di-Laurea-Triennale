...
il grafo \ref{fig:aosta-rimini-milano-trimestre}, dividendo gli eventi 
...
un'impennata di valori nella prima heatmap. 
...
Un'ipotesi, è che il dataset contenga solo eventi con almeno un ferito, 
...
maggiore numero di sinistri nel 2018. \todo{atrent: abolirei la parola "scontro", se non vuoi ripetere "incidente" usa "evento" o altri sinonimi}
