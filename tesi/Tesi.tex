...
\begin{figure}
    \includegraphics[width=\linewidth]{../src/meteo/arpa.png}
...
\todo{continua a guardare da qui}
...
Per realizzare la figura \ref{fig:line-incidenti-milano}, sono state prese in 
considerazione alcune tra le autostrade e strade statali più trafficate e si è segnata 
la posizione approssimata.
