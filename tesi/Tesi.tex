...
\newcommand{\lighttext}[1]{\vspace{0.2in}\noindent\light{\texttt{#1}}\vspace{0.2in}}
...
solamente diviso in dodici file su base mensile, problema ricorrente, in 
quanto le condivisioni di open data venivano misurate sulla base del numero di file, 
era quindi più proficuo pubblicare dati separati.
\todo{lelepado: ancora oggi?}

Infine, un problema sorto con frequenza è stato la mancanza di descrizioni del 
significato dei campi di un dataset. 
Un esempio di ciò può essere i dati provenienti dal geoportale del comune di Milano 
dove, in molti casi, si è dovuto ipotizzare il significato delle colonne, e di conseguenza 
si è stati costretti a scartare queste informazioni.
