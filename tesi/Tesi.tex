...
mettendo in luce aspetti non ancora tenuti in considerazione, o che semplicemente 
non sono disponibili da fonti come quotidiani o siti internet.

Esplorando l'esempio fatto in precedenza, ci si potrebbe domandare quali sono le zone di Milano 
...
\begin{center}
    ...
    \begin{tabular}{ |c|c|c|c| }
        \hline
        Autovelox & Incidenti totali & Incidenti per $Km^2$ & Incidenti zona \\ 
        \hline
        \rowcolor{TableGray}
...
in quanto a partire dal 2011, utilizzando i dati sul numero degli accessi all'area C.
...
la percentuale di accessi in area C a una determinata ora, e il numero di incidenti a Milano, 
pesati in base al questa stima del traffico.\\
...
\ref{fig:aosta-rimini-milano-trimestre} 
...
I grafi equivalenti di Milano e Rimini, nelle mappe in figura \ref{fig:aosta-rimini-milano-trimestre}, 
