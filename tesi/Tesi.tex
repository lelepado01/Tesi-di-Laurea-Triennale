...
\begin{figure}
    \includegraphics[width=0.5\linewidth]{../dataset/area_c/perimetro_area_c.jpg}
    \includegraphics[width=0.5\linewidth]{../src/area_c/area_c_incidenti.png}
...
\todo{Aggiungere spiegazione su tipologia della strada e fare confronto con il traffico}
