...
\todo{atrent: questa sezione entra già nel tecnico}
...
\todo{atrent: in generale (cioè vale un po' ovunque) manca una critica alla qualità dei dati 
e alla loro significatività (in questo caso ad esempio bisogna domandarsi quanto questo 
dataset sia un proxy del traffico)}
...
\begin{figure}
    \includegraphics[width=\linewidth]{../src/autovelox/autovelox_indici.png}
...
\todo{lelepado: La correlazione è stata realizzata con i valori cumulati delle ore, 
non con il campione, perchè gli accessi in area C sono già parzialmente cumulati, va bene?}
...
Per tutti gli altri anni, per cui sono disponibili dati sul mese dell'incidente, la tendenza è 
quella della figura \ref{fig:aosta_gen}.

\begin{figure}
    \includegraphics[width=\linewidth]{../src/incidenti/incidenti_senza_coords/mese_incidenti/aosta_mese_gen.png}
    \caption{Incidenti per mese Valle d'Aosta, i grafi di 2011 e 2012 sono equivalenti}
    \label{fig:aosta_gen}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
\todo{lelepado: Ho poche cose qui}
...
\begin{figure}
    ...
    \caption{Incidenti e temperature medi per mese nel 2013}
    \label{fig:incidenti-temp}
\end{figure}

La figura \ref{fig:incidenti-temp} mostra, nel grafo di sinistra, il numero di incidenti 
avvenuti per mese, mentre il grafo di destra indica la temperatura media.
...
Senza conoscere gli incidenti giorno per giorno non è possibile avere un 
