...
Si sono ricavate alcune località in cui si è riscontrata la tendenza inversa, come in provincia 
...
\begin{figure}
    \includegraphics[width=\linewidth]{../src/incidenti/incidenti_senza_coords/mese_incidenti/rimini_palermo_milano.png}
    \caption{Incidenti per mese a Milano, Palermo e Rimini}
    \label{fig:rimini-palermo-milano}
\end{figure}
