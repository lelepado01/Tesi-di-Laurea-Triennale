...
\todo{lelepado: faccio altre zone?}
...
La mappa \ref{fig:autovelox-incidenti} è stata realizzata contando gli incidenti avvenuti vicino a 
ogni autovelox.

\todo{capire se il radius è in metri o cosa}
\todo{calcolare incidenti per km2 e comparare con incidenti nella zona}
