...
Una volta divisi i dati, è possibile calcolare l'indice tramite il metodo \methodstyle{corr()}, 
...
\todo{conclusione, magari su correlazione non causa/effetto}
...
Nella figura \ref{fig:incidenti-autostrade} sono  raffigurate le autostrade con maggiore numero 
di incidenti nel 2018. Non è una sorpresa che le prime posizioni della lista 
coincidano anche con le strade più trafficate, come l'Autostrada del Sole e l'Adriatica.

\todo{controllare se ci sono annate diverse}
\todo{allungare capitolo}
...
Una motivazione di questo fenomento potrebbe essere, il cambiamento delle mode riguadanti 
