...
influisca sugli, o se gli autovelox rendano più attenta 
...
\todo{è coomposto da un ampia quantità di informazioni, non utili al fine dell'analisi, 
ma tra queste si è risciti a ricavare il numero di cose utili}
...
\todo{spiegare meglio la stima dal basso}
...
\todo{ma non è particolarmente utile poichè lo studio è stato svolto in concomutanza a un lungo periodo di quarantena dovuto al covid 19 le cui limitazioni hanno ridotto in maniera significariva i volumi di traffico}
...
interna e esterna, e Piazza Kennedy e Cavalcavia del Ghisallo.
\todo{evidenziando zona navigli}
...
\todo{spiegare come si è ottenuto grafo di destra}
