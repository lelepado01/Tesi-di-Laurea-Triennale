...
- atrent: è un difetto di latex, a volte non riesce a calcolare bene la lunghezza del typeset}
...
- atrent: usa il package 'listings', te lo avevo aggiunto in cima}
...
\todo{lelepado: è giusto come ho citato capitolo e pagine qui? atrent: vedi l'altro sotto}
...
\todo{lelepado: nel link che mi ha mandato non ho visto nulla per gli orari, vanno bene così o devo usare il punto, come 7.00? atrent: va bene il ":"}
...
\end{figure}
\todo{lelepado: se il codice che ho usato per questo tipo di heatmap è stato in parte preso dalla documentazione/esempi, devo citarlo? atrent: se doc ufficiale no}
...
\todo{lelepado: è giusto come ho citato capitolo e pagine qui? atrent: aggiunto citetitle, puoi usarlo anche in altri punti}
...
\todo{lelepado: posso dirlo? atrent: mettilo come ipotesi}
...
$intersezione\_o\_non\_interse1$, mentre nel 2018, la stessa informazione prende il nome
di $intersezione\_o\_non\_interse3$.
\todo{lelepado: questi due label su pdf escono dai margini - atrent: solito problema latex, ho fatto quache prova ma senza successo, prova a cercare su stackoverflow}
