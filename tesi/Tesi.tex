...
\end{figure}
\todo{atrent: citare sempre fonte immagini
lelepado: questa la avevo presa dalle sue slide di 
cittadinanza digitale, come faccio a citarla?
atrent: in questo caso puoi semplicemente mettere (fonte: Trentini)}
...
\chapter{Conclusioni}\todo{atrent: minimale, ma per ora va bene così, da rielaborare a freddo}

\todo{atrent: di solito si ricapitolano gli scopi}
...
sulla base del numero di file pubblicati.\todo{atrent: riesci a trovare qualche articolo che ne parla? te lo avevo detto io ma sarebbe carino trovare qualcuno che lo abbia detto pubblicamente, anche solo su web, era una cosa tipo "valutazione delle PA nell'opendata"}
Era quindi più proficuo pubblicare dati separati, rispetto a tutte le informazioni in 
un unico dataset.\todo{atrent: a me pareva di averlo segnalato, non c'è da nessuna parte una introduzione all'opendata, in cui si potrebbe dire cosa sono, come vengono classificati (Berners-Lee e Davies) e quali siano i processi di pubblicazione}
...
e di conseguenza si è stati costretti a scartare queste informazioni. \todo{atrent: metterei almeno uno screenshot, sicuro che non c'è descrizione campi?}
...
A cambiare non sono soltanto i nomi dell\todo{TYPO} colonne negli anni, ma in alcuni casi, 
...
atrent: inteso come un capitolo "conclusioni"? ci può stare, breve, in cui riassumi i 
problemi affrontati e le informazioni raccolte/calcolate
aggiungo: importante sarebbe anche (sempre nelle conclusioni) fare un rapporto sullo 
stato dei dati disponibili, sulla loro qualità e granularità (btw mi viene in mente 
che servirebbe una digressione, in zona intro, sugli opendata) e sulle migliorie che 
si potrebbero chiedere ai produttori degli opendata che hai man mano trovato}

\appendix
\chapter{Appendice A: Codice}\todo{atrent: a questo punto non è più un appendice, puoi metterla come sezione delle conclusioni o nell'intro}
