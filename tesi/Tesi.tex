...
% Separazione a capo delle parole è spesso sbagliata
\usepackage{hyphenita}
...
possono avvenire scontri tra vetture. 
...
\end{figure}\todo{atrent: attenzione alle scale!!! dovunque tu vuoi fare un confronto visivo tra grafici devi avere la stessa scala!!! vale dappertutto, l'ho notato qui, fai verifica su tutta la tesi}
...
incidenti. \todo{atrent: considerazione che vale un po' ovunque, attenzione che stai dando (a meno che non lo specifichi) valori assoluti, non in rapporto al traffico, alla popolazione, ai km di strade, ecc. tienilo sempre ben presente}
...
esistono differenze sostanziali tra le due categorie? \todo{correzione}
...
\end{figure}\todo{atrent: vale discorso assoluto/relativo}

Nella figura \ref{fig:incidenti-autostrade} sono  raffigurate le strade con 
maggiore numero di scontri nel 2018. \todo{atrent: abolirei la parola "scontro", se non vuoi ripetere "incidente" usa "evento" o altri sinonimi}
