...
\begin{figure}
    \includegraphics[width=0.5\linewidth]{../src/municipi_milano/municipio_solo.png}
    \includegraphics[width=0.5\linewidth]{../src/municipi_milano/incidenti_bubble.png}
...
\todo{affianca tabella a grafo sopra}
\begin{center}
    \def\arraystretch{1.5}%  
    \begin{tabular}{ |c|c| } 
    \hline
...
un unico dataset.
\todo{atrent: a me pareva di averlo segnalato, non c'è da nessuna parte una introduzione all'opendata, in cui si potrebbe dire cosa sono, come vengono classificati (Berners-Lee e Davies) e quali siano i processi di pubblicazione}
