...
% \ref{fig:incidenti-traffico-ora}
...
A supporto dell'ipotesi iniziale, nella figura \ref{fig:stima-traffico-mensile}, è visibile un calo di accessi all'area C durante il 
mese di Agosto.
...
\todo{lelepado: grafo con mesi incidenti e traffico}
