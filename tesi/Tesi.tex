...
soprattutto negli anni precedenti al 2017 quando, per ottenere le loro informazioni sulla qualità dell'aria si sarebbe dovuto compilare un 
...
\begin{figure}
    ...
    \label{fig:arpa}
\end{figure}\todo{atrent: la fonte si mette tra parentesi nella caption, inoltre metti le label su ogni figura e citala nel testo}
...
\todo{atrent: perché non una bullet list?}
