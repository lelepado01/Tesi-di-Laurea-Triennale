...
\todo{reference alla tabella di autovelox ZTLMilano}
...
per esempio 
\todo{lelepado: finire, serve indice numerico}
...
\begin{figure}
    \includegraphics[width=0.4\linewidth]{../src/incidenti/incidenti_senza_coords/mese_incidenti/milano_rimini.png}
    \caption{Incidenti per mese a Milano e Rimini}
    \label{fig:milano-rimini}
\end{figure}

\begin{figure}
    \includegraphics[width=0.4\linewidth]{../src/incidenti/incidenti_senza_coords/mese_incidenti/palermo_milano.png}
...
\todo{lelepado: sto facendo giusto a moltiplicare per 1-percentuale?}
...
Se invece si guardasse il trimestre estivo?
...
\todo{lelepado: perchè agosto è così alto? Confronto con altri mesi}
