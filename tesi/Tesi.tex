...
\todo{usa command invece di textit e prova roboto}
...
con \columnstyle{incroci} e \columnstyle{intersezioni non segnalate} che spiccano come tipi di strada con 
...
misura della distanza dei dati di un campione dalla media\cite{PROB.E.STATISTICA:2}}.
