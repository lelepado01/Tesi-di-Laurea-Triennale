...
\todo{lelepado: è giusto come ho citato capitolo e pagine qui?}
...
\todo{Da riguardare, ho aggiunto un pezzo}
...
verso altre regioni durante il mese estivo, la differenza di traffico è osservabile 
...
In particolare, ad aumentare in volume sono Brescia e Palermo.
...
Nella seguente tabella, sono indicate le percentuali di aumento per anno dei sinistri 
a Rimini.
L'incremento più o meno costante in ogni anno, conferma questo fenomeno come 
...
la quantità di sinistri è generalmente più basso rispetto alla media.
...
dimensioni più contenute e un manto stradale meno esteso.
...
dividere i sinistri in base alla provincia in cui sono avvenuti.
...
dovuto all'estensione della strada nella provincia. 
Inoltre, a eccezione di alcune zone, come Bari, Savona, Viterbo e Massa-Carrara, 
la maggior parte degli incidenti sembra essere omogeneamente distribuito lungo tutta 
...
con taglia del campione significativa.}.
...
precisi, per esempio suile tratte percorse pendolari, sarebbe possibile realizzare analisi 
più approfondite.
...
Il grafo a barre \ref{fig:autostrade-anno-agosto} sono elencate le 
autostrade in cui sono avvenuti più incidenti nel mese di Agosto, per annata. 
In questo grafico, si è tentato un approccio diverso rispetto a quello del capitolo precedente, 
elencando le strade più pericolose per anno e numero di sinistri, invece di usare una 
...
facilitare la lettura delle tratte, infatti colori diversi corrispondono a direttrici diverse. 
...
Un esempio di questi dataset, potrebbe essere sapere il giorno e l'ora 
...
Entrambi questi dati non sono disponibili tramite open data e, probabilmente, 
...
nella relazione\footnote{Ci si riferisce alle immagini ottenute tramite screenshot 
