...
L'ultimo dataset, trovato dopo veloce cosultazione con un dipendente Istat, è stato il dataset ACI
...
tuttavia questo consisteva in un file molto grande e difficile da elaborare.
...
\begin{figure}
    \includegraphics[width=0.49\linewidth]{../dataset/area_c/perimetro_area_c.png}
    \includegraphics[width=0.49\linewidth]{../src/area_c/area_c_incidenti.png}
...
Per realizzare la figura \ref{fig:bubble-incidenti-milano}, sono state prese in considerazione alcune 
...
\todo{rifare ma utilizzare linee e non punti}
