...
\end{figure}
\todo{atrent: citare sempre fonte immagini lelepado: questa la avevo presa dalle sue slide di 
...
\lighttext{(\\
    ...
    \indent veicolo\_\_a\_\_\_et\_\_conducente: questi campi sono ripetuti anche per i passeggeri,\\
    \indent veicolo\_\_a\_\_\_sesso\_conducente,\\veicolo\_\_a\_\_\_esito\_conducente, \\
    \indent morti\_entro\_24\_ore, morti\_entro\_30\_giorni,\\
    \indent feriti, Ora, trimestre\\
)}
...
\lighttext{(\\
    ...
    \indent COD PROV,PROVINCIA,NOME STRADA,\\
    \indent INC: numero di incidenti (ce ne sono più per riga),\\
    \indent di cui MORTALI,MOR,FER,\\
...
e \columnstyle{tesi}. La prima contiene tutti i file di informazioni utilizzati, divisi per 
...
Infine, nella directory \columnstyle{src} è contenuto il codice sorgente utilizzato per realizzare 
...
lo stesso nome, e estensione \columnstyle{.py}. 
Quindi se in una cartella fosse presente l'immagine \columnstyle{esempio.png}, lo script con 
cui questa è stata creata avrà nome \columnstyle{esempio.py}.

Invece, se si volesse trovare il codice del grafo raffigurante l'incremento di incidenti 
dal 2010 al 2018, i dataset utilizati si troverebbero nella directory:
\skipline
\indent\columnstyle{dataset/incidenti/incidenti\_istat}
\skipline
Mentre il codice sorgente e le immagini sarebbero situate al percorso:
\skipline
