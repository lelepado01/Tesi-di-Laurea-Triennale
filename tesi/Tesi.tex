...
%\usepackage[paperheight=20cm,paperwidth=12.5cm,inner=2.3cm,outer=1.3cm,bottom=1.8cm,top=1.9cm]{geometry}
% \usepackage[inner=3cm,outer=2cm,bottom=3cm,top=3cm]{geometry}
...
\begin{center}
    $Indice\_Mortalita\_Strada = \displaystyle \frac{Numero\_Morti\_Strada}{Numero\_Incidenti\_Strada} \times 100$ 
\end{center}
...
\begin{center}
    $Indice\_Mortalita = \displaystyle \frac{Numero\_Morti}{Numero\_Incidenti} \times 100$ 
\end{center}
...
\todo{specificare a cosa sono rapportati gli incidenti, o se sono valori assoluti}
