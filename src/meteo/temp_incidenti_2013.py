...
plt.subplot(311)
plt.bar(inc.index, inc, color='#96c176', width=0.9)
plt.ylabel("Incidenti per mese (2013)")
plt.xticks(range(1,13))

plt.subplot(312)
plt.ylabel("Temperatura media (°C)")
plt.bar(meteo_per_mese.index, meteo_per_mese, color='#7696c1', width=0.9)
plt.xticks(range(1,13))

plt.subplot(313)
plt.ylabel("Umidità media")
plt.bar(umid.index, umid, color='#c17696', width=0.9)
plt.xticks(range(1,13))
plt.show()