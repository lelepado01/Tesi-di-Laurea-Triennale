...
raccordo = sum_columns(raccordo[ore])
ss16 = sum_columns(ss16[ore])
ss1 = sum_columns(ss1[ore])

plt.subplot(3,1,1)
raccordo.plot.bar(color='#d888b3')
plt.ylabel("Raccordo Anulare\nRoma")
plt.xticks(range(0,25,2), rotation=0)
plt.tight_layout()

plt.subplot(3,1,2)
ss16.plot.bar(color='#88b3d8')
plt.ylabel("SS16\nprovincia di Bari")
plt.xticks(range(0,25,2),rotation=0)
plt.tight_layout()

plt.subplot(3,1,3)
ss1.plot.bar(color='#b3d888')
plt.ylabel("SS1\nprovincia di Genova")
plt.xticks(range(0,25,2),rotation=0)
plt.tight_layout()
plt.show()